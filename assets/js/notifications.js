...
if (!window._notificationsGlobalsInitialized) {
    ...
    document.addEventListener('click', function(e) {
        ...
        if (clearBtn) {
            ...
            if (pendingNotifs.length > 0) {
                ...
                window.localStorage.setItem('epiGuard_lastSeenNotifId', pendingNotifs[0].id);
            }
            refreshSPA();
    ...
    function renderNotification(notif) {
        ...
        readBtn.addEventListener('click', function(e) {
            ...
            const currentSeen = parseInt(window.localStorage.getItem('epiGuard_lastSeenNotifId')) || 0;
            const newSeen = Math.max(currentSeen, parseInt(notif.id));
            window.localStorage.setItem('epiGuard_lastSeenNotifId', newSeen);
    ...
    function refreshSPA() {
        ...
        let lastSeenId = parseInt(window.localStorage.getItem('epiGuard_lastSeenNotifId')) || 0;
