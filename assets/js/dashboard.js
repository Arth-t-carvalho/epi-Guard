...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // --- Integração Sincronizada com Notificações ---
    window.addEventListener('epi-new-notification', (e) => {
        // Atualiza a lista de "Registro de Ocorrência" no Dashboard
...
// Desbloqueia o áudio ao primeiro clique (para permitir o Ping Mobile)
document.addEventListener('click', function unlockAudio() {
    const dummyAudio = new Audio("https://assets.mixkit.co/active_storage/sfx/2869/2869-preview.mp3");
    dummyAudio.volume = 0;
    dummyAudio.play().then(() => {
        console.log("🔊 Sistema de áudio Mobile liberado!");
