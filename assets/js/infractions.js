    ...
    try {
        ...
        if (result.success) {
            if (format === 'pdf') {
                ...
                generatePremiumInfractionExcel(result.data);
            }
 ...
 */
async function generatePremiumInfractionPDF(data) {
    ...
    for (let i = 1; i <= pageCount; i++) {
        ...
        doc.text("epiGuard © 2026 - Todos os direitos reservados", 15, 285);
    }
