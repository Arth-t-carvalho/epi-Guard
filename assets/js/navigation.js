...
async function navigateViaSPA(destino, options = {}) {
    ...
    const stickySelectors = [
        ...
        '.evidence-modal-overlay', '.modal-premium', '.modern-picker-backdrop', '.ai-backdrop'
    ];
...
/**
 * Altera o idioma do sistema via cookie e recarrega a página.
 * @param {string} lang 'en' ou 'pt-br'
 */
function changeLanguage(lang) {
    // Altera o cookie para que o PHP possa entender a nova linguagem
    document.cookie = "Facchini-lang=" + lang + ";path=/;max-age=31536000;SameSite=Lax";
    // Guarda também no localStorage por consistência lateral do front
    localStorage.setItem('Facchini-lang', lang);
