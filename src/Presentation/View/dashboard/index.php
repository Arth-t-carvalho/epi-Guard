...
$extraHead = '
    <!-- Page CSS -->
    <link rel="stylesheet" href="' . BASE_PATH . '/assets/css/dashboard.css?v=' . @filemtime(BASE_DIR . '/assets/css/dashboard.css') . '">
    <link rel="stylesheet" href="' . BASE_PATH . '/assets/css/modal/modalDashboard.css?v=' . @filemtime(BASE_DIR . '/assets/css/modal/modalDashboard.css') . '">
    <link rel="stylesheet" href="' . BASE_PATH . '/assets/css/modal/modalCompliance.css?v=' . @filemtime(BASE_DIR . '/assets/css/modal/modalCompliance.css') . '">
    <link rel="stylesheet" href="' . BASE_PATH . '/assets/css/modal/modalGestaoSetor.css?v=' . @filemtime(BASE_DIR . '/assets/css/modal/modalGestaoSetor.css') . '">
    <!-- Dependencies -->
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.23/jspdf.plugin.autotable.min.js"></script>
';
$extraScripts = '<script src="' . BASE_PATH . '/assets/js/dashboard.js?v=' . @filemtime(BASE_DIR . '/assets/js/dashboard.js') . '"></script>';
...
<!-- KPI CARDS -->
<div class="kpi-grid">
    <div class="kpi-card card" id="cardKpiHoje" onclick="confirmRedirect('hoje')" style="cursor: pointer;">
    ...
    <div class="kpi-card card" id="cardKpiSemana" onclick="confirmRedirect('semana')" style="cursor: pointer;">
    ...
    <div class="kpi-card card" id="cardKpiMes" onclick="confirmRedirect('mes')" style="cursor: pointer;">
