<?php
$pageTitle = 'Facchini - Painel Geral';
$extraHead = '
    <!-- Page CSS -->
    ...
    <!-- Dependencies -->
    <script src="' . BASE_PATH . '/assets/vendor/chart.min.js?v=' . APP_VERSION . '"></script>
    <script src="' . BASE_PATH . '/assets/vendor/jspdf.umd.min.js?v=' . APP_VERSION . '"></script>
    <script src="' . BASE_PATH . '/assets/vendor/jspdf.plugin.autotable.min.js?v=' . APP_VERSION . '"></script>
';
$extraScripts = '<script src="' . BASE_PATH . '/assets/js/dashboard.js?v=' . APP_VERSION . '"></script>';
...
<style>
    ...
    #detailSearchInput {
        ...
        border: 1.5px solid #e2e8f0;
        border-radius: 0px;
        /* Estilo Facchini strictly squared */
        font-size: 14px;
        color: #1e293b;
        background: #f8fafc;
        transition: all 0.2s ease;
...
<div class="kpi-grid">
    <div class="kpi-card card" id="cardKpiHoje"
        onclick="window.location.href = '<?= BASE_PATH ?>/infractions?periodo=hoje'" style="cursor: pointer;">
        ...
        <div class="kpi-badges-row">
            ...
            <span class="kpi-state-badge" id="stateKpiDia" style="display:none;"></span>
        </div>
    </div>

    <div class="kpi-card card" id="cardKpiSemana"
        onclick="window.location.href = '<?= BASE_PATH ?>/infractions?periodo=semana'" style="cursor: pointer;">
        ...
        <div class="kpi-badges-row">
            ...
            <span class="kpi-state-badge" id="stateKpiSemana" style="display:none;"></span>
        </div>
    </div>

    <div class="kpi-card card" id="cardKpiMes"
        onclick="window.location.href = '<?= BASE_PATH ?>/infractions?periodo=mes'" style="cursor: pointer;">
        ...
        <div class="kpi-badges-row">
            ...
            <span class="kpi-state-badge" id="stateKpiMes" style="display:none;"></span>
        </div>
    </div>
    ...
    <div class="kpi-card card" id="cardKpiMedia" onclick="openComplianceModal()" style="cursor: pointer;">
        ...
        <div class="kpi-badges-row">
            <span class="kpi-trend-badge" id="trendKpiConformidade" style="display:none;"></span>
            <span class="kpi-state-badge" id="stateKpiConformidade" style="display:none;"></span>
        </div>
    </div>
</div>
