...
<div class="kpi-grid">
    <div class="kpi-card card">
        <span class="kpi-header">INFRACOES HOJE</span>
        <div class="kpi-value">
    ...
    <div class="kpi-card card">
        <span class="kpi-header">INFRACOES SEMANA</span>
        <div class="kpi-value">
    ...
    <div class="kpi-card card">
        <span class="kpi-header">INFRACOES MES</span>
        <div class="kpi-value">
...
<div class="chart-card card">
    <div class="chart-header-actions">
        <h3 class="chart-title">Visao Geral Mensal</h3>
...
<div class="chart-grid">
    ...
    <!-- Top Infracoes (Placeholder) -->
    <div class="card">
        <div class="section-header">
            <h3 class="section-title">Top Ocorrencias</h3>
        </div>
        <div class="infraction-list" id="topInfractions">
            <div class="list-item">
                <span class="occ-name">Nenhum Registro</span>
