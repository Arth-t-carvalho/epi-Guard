...
$userEmail = $_SESSION['user_email'] ?? 'admin@facchini.com.br';
?>
<div class="settings-container fade-in">
    <div class="settings-header">
        <div>
            <h1><?= __('Configurações do Sistema') ?></h1>
            <p><?= __('Gerencie suas preferências, aparência e alertas do Facchini.') ?></p>
        </div>
    </div>
                ...
                <div class="setting-item">
                    ...
                    <div class="setting-action">
                        <select class="settings-select" id="languageSelect" onchange="changeLanguage(this.value)">
                            <option value="pt-br" <?= ($_COOKIE['facchini-lang'] ?? 'pt-br') === 'pt-br' ? 'selected' : '' ?>><?= __('Português (Brasil)') ?></option>
                            <option value="en" <?= ($_COOKIE['facchini-lang'] ?? '') === 'en' ? 'selected' : '' ?>>
