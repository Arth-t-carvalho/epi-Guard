                    ...
                    <div class="infraction-card<?= !empty($infraction['favorito']) ? ' is-bookmarked' : '' ?>"
                        ...
                        <div class="card-content-premium">
                            ...
                            <div class="card-footer-premium">
                                <?php
                                $durationText = formatInfractionDuration($infraction['data_hora'], $infraction['resolvido_em'] ?? null);
                                $args = json_encode([
                                    ...
                                    $infraction['acao_obs'] ?? '',
                                    $infraction['responsavel_nome'] ?? '',
                                    $infraction['responsavel_cargo'] ?? ''
                                ]);
                                ?>
        ...
        <div class="modal-premium-body">
            ...
            <div class="export-step" id="formatStep" style="display: none;">
                ...
                <div class="export-actions-stack">
                    ...
                    <button class="btn-liquid print-report" onclick="processExport('print')">
...
<script>
    ...
    function applyCustomDate(isManual = true) {
        ...
        if (!from || !to) {
            if (isManual) alert('<?= __('Por favor, selecione as duas datas.') ?>');
            return;
        }
