...
<head>
    ...
    <link rel="stylesheet"
        href="<?= BASE_PATH ?>/assets/css/global.css?v=<?= filemtime(__DIR__ . '/../../../../assets/css/global.css') ?>">
    <link rel="stylesheet"
        href="<?= BASE_PATH ?>/assets/css/sidebar.css?v=<?= filemtime(__DIR__ . '/../../../../assets/css/sidebar.css') ?>">
    <link rel="stylesheet" href="<?= BASE_PATH ?>/assets/css/modal/modalBase.css">
    <link rel="stylesheet" href="<?= BASE_PATH ?>/assets/css/custom-select.css">
...
<body data-base-path="<?= BASE_PATH ?>">
    ...
    <script src="<?= BASE_PATH ?>/assets/js/custom-select.js"></script>
    <script
        src="<?= BASE_PATH ?>/assets/js/notifications.js?v=<?= filemtime(__DIR__ . '/../../../../assets/js/notifications.js') ?>"></script>
    <?= $extraScripts ?? '' ?>
