<?php
$pageTitle = 'Facchini - Monitoramento em Tempo Real';
$extraHead = '
    <link rel="stylesheet" href="' . BASE_PATH . '/assets/css/monitoring.css?v=' . @filemtime(BASE_DIR . '/assets/css/monitoring.css') . '">
';
