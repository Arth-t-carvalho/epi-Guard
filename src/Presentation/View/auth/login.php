...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_PATH ?>/assets/css/auth.css?v=<?= @filemtime(BASE_DIR . '/assets/css/auth.css') ?>">
    <link rel="icon" type="image/png" href="<?= BASE_PATH ?>/assets/images/logo.png?v=<?= @filemtime(BASE_DIR . '/assets/images/logo.png') ?>">
</head>
<body>
    ...
    <script src="<?= BASE_PATH ?>/assets/js/auth.js?v=<?= @filemtime(BASE_DIR . '/assets/js/auth.js') ?>"></script>
</body>
</html>
