...
<head>
    ...
    <title>epiGuard - <?= __('Recuperar Senha') ?></title>
    <script>
            ...
            <div class="login-form-area">
                <div class="form-container">
                    <header class="form-header">
                        ...
                        <p><?= __('Informe seus dados abaixo para enviarmos as instruções de recuperação.') ?></p>
                    </header>
                    ...
                    <form id="reset-password-form" method="POST" action="<?= BASE_PATH ?>/recuperar-senha">
                        ...
                        <div class="input-group">
                            <label for="email"><?= __('E-MAIL (GMAIL)') ?></label>
                            <div class="input-wrapper">
                        ...
                        <button type="submit" class="btn-login">
                            <?= __('REDEFINIR SENHA') ?> <i class="fa-solid fa-chevron-right"></i>
                        </button>

                        <div class="form-footer">
                            <p><?= __('Lembrou a senha?') ?> <a href="<?= BASE_PATH ?>/login" class="link-register"><?= __('Fazer Login') ?></a></p>
                        </div>
                    </form>
                </div>
            </div>
