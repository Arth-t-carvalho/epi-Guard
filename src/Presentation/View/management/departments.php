...
<script>
    (function () {
        ...
        async function addMachine() {
            ...
            if (!nome) {
                alert('<?= __('Informe o nome da máquina.') ?>');
                return;
            }
            ...
            try {
                ...
                alert('<?= __('Erro ao salvar máquina.') ?>');
            }
        }

        async function deleteMachine(id) {
            if (!confirm('<?= __('Deseja realmente excluir esta máquina?') ?>')) return;
            ...
            try {
                ...
                alert('<?= __('Erro ao excluir máquina.') ?>');
            }
        }
