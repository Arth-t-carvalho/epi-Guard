    ...
    public function create(): void
    {
        ...
        try {
            ...
            $this->auditService->log(
                ...
                null,
                json_encode(['nome' => $employee->getName(), 'setor' => $employee->getDepartment()->getName()])
            );
    ...
    public function delete(): void
    {
        ...
        try {
            ...
            if ($employee) {
                ...
                // Audit Log: Exclusão (Soft Delete)
                $userId = $_SESSION['user_id'] ?? 0;
                $this->auditService->log(
                    (int)$userId,
                    'DELETE',
                    ...
                    (int)$employee->getId(),
                    $_SERVER['REMOTE_ADDR'] ?? '0.0.0.0',
                    json_encode(['id' => $employee->getId(), 'nome' => $employee->getName()]),
                    null
                );
