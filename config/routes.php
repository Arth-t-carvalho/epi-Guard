...
return [
    ...
    '/management/ad' => [ManagementController::class, 'adManagement'],
    '/management/employees' => [ManagementController::class, 'employees'],
    '/management/instructors' => [ManagementController::class, 'instructors'],
    '/api/ad-users' => [\Facchini\Presentation\Controller\Api\AdApiController::class, 'list'],
    '/api/ad-users/save' => [\Facchini\Presentation\Controller\Api\AdApiController::class, 'save'],
    '/api/ad-users/delete' => [\Facchini\Presentation\Controller\Api\AdApiController::class, 'delete'],
    ...
    '/api/employees/sync-all-ad' => [\Facchini\Presentation\Controller\Api\EmployeeApiController::class, 'syncAllToAd'],
    '/management/template-pdf' => [ManagementController::class, 'templatePdf'],
