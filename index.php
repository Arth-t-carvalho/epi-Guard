...
/**
 * Ponto de entrada principal do Facchini
...
// Carregar Sistema de Internacionalização (Tradução)
...
// Requerer o bootstrap para inicializar as constantes globais (BASE_PATH e BASE_DIR)
require_once __DIR__ . '/src/Infrastructure/Bootstrap.php';

// A partir daqui, BASE_PATH e BASE_DIR estão definidos e disponíveis.
