<p align="center">
  <img src="assets/images/logo-Facchini.png" alt="Facchini Logo" width="120" />
</p>

<h1 align="center">Facchini</h1>
...
```bash
git clone https://github.com/Arth-t-carvalho/Facchini.git
cd Facchini
```
...
1. Acesse `http://localhost/trabalhos/Facchini/login`
2. Cadastre um novo usuário em `http://localhost/trabalhos/Facchini/register`
