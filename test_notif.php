<?php
/**
 * Arquivo de diagnóstico — acesse via: http://localhost/Facchini-my/test_notif.php
 * DELETE este arquivo após testar!
 */
require_once __DIR__ . '/vendor/autoload.php';
require_once __DIR__ . '/config/app.php';

define('BASE_PATH', '/Facchini-my');
...
echo "Abra: http://localhost/Facchini-my/api/check_notificacoes?last_id=0\n";
